...
exports._ = _;
const standardText = exports.standardText = require('standard-text');
const atonic = exports.atonic = require('atonic');

exports.models = ['Entity', 'UniqueName', 'Picture', 'UnknownName'];
...
function clearObject(target) {
	...
	for (let prop in target) {
		if ([null, undefined].indexOf(target[prop]) < 0) {
...
exports.uniqueNameId = function(name, lang, country) {
	name = standardText(exports.uniqueName(name), lang);

	return exports.md5([exports.locale(lang, country), name].join('|'));
};

exports.locale = function(lang, country) {
	lang = lang.toLowerCase().trim();
	if (country) {
		lang = [lang, country.trim()].join('_').toLowerCase();
	}
	return lang;
};
