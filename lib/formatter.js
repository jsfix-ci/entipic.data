...
external.normalizeTopic = function(data) {
	data = _.pick(data, 'name', 'uniqueName', 'id', 'type', 'pictureId', 'country', 'pictureDomain', 'englishWikiDescription', 'englishWikiName', 'englishWikiId', 'refIP', 'refHost', 'popularity');
